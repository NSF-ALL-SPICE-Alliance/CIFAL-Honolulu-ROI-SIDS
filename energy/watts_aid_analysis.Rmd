...
energy_aid_indicators_renewable_watts_relevant_topics_grouped_country <- energy_aid_indicators_renewable_watts_relevant_topics_grouped %>% 
  filter(recipient_name == "Cabo Verde")  
...
```{r}
energy_aid_tonga <- energy_aid_indicators_renewable_watts_relevant_topics_grouped %>% 
  filter(recipient_name == "Cabo Verde")  %>% 
  drop_na()

aid_ts_tonga <- ts(energy_aid_tonga$renewable_disbursement)
watts_ts_tonga <- ts(energy_aid_tonga$Renewable_watts_per_capita)


lag2.plot(aid_ts_tonga, watts_ts_tonga, max.lag = 8)
